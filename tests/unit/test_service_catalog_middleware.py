"""Tests for ServiceCatalogMiddleware."""

from unittest.mock import Mock

import pytest

from src.agent.middleware.service_catalog import ServiceCatalogMiddleware


class TestServiceCatalogMiddleware:
    """Test suite for ServiceCatalogMiddleware."""

    @pytest.fixture
    def middleware(self):
        """Create middleware instance."""
        return ServiceCatalogMiddleware()
    ...
    def test_state_schema_fields(self, middleware):
        ...
        assert "selected_service" in annotations
    ...
    def test_tool_name(self, middleware):
        """Test service catalog tool name."""
        assert middleware.tools[0].name == "browse_services"
