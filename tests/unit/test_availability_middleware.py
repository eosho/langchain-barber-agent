"""Tests for AvailabilityMiddleware."""

from unittest.mock import Mock

import pytest

from src.agent.middleware.availability import AvailabilityMiddleware


class TestAvailabilityMiddleware:
    """Test suite for AvailabilityMiddleware."""

    @pytest.fixture
    def middleware(self):
        """Create middleware instance."""
        return AvailabilityMiddleware()
    ...
    def test_state_schema_fields(self, middleware):
        ...
        assert "availability_info" in annotations
    ...
    def test_tool_name(self, middleware):
        """Test availability tool name."""
        assert middleware.tools[0].name == "check_availability"
