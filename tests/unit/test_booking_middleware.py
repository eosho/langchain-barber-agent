"""Tests for BookingMiddleware."""

from unittest.mock import Mock

import pytest

from src.agent.middleware.booking import BookingMiddleware


class TestBookingMiddleware:
    """Test suite for BookingMiddleware."""
    ...
    def test_state_schema_fields(self, middleware):
        ...
        assert "booking_info" in annotations
